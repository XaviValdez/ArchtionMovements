	...
	<div class="row mt-5">
		...
		<div class="col-sm-4 cut">
			<div class="bg-blue p-5">
				<p class="text-center text-white lead mt-5" style="letter-spacing: 5px;">SOCIAL</p>
		...
		<div class="col-sm-4 cut">
			<div class="bg-green p-5">
				<p class="text-center text-white lead mt-5" style="letter-spacing: 5px;">AMBIENTAL</p>
				<p class="p-4 lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua.</p>
		...
		<div class="col-sm-4 cut">
			<div class="bg-orange p-5">
				<p class="text-center text-white lead mt-5" style="letter-spacing: 5px;">ECONÓMICO</p>
				<p class="p-4 lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua.</p>
			</div>
		</div>
