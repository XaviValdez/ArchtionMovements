<footer class="bg-dark text-center text-lg-start mfooter text-white">
    <div class="text-center p-3 bg-black">
        <br><br>
        <a href="landing.php">
            <img class="mt-4 logo-footer" src="../img/dark_logo.png">
        </a>
        <br><br>
...
<script src="../js/navbar.js"></script>
    <script src="../js/facebook_login.js?v=<?php echo $version; ?>"></script>
