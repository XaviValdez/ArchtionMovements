...
<div class="container mt-3">
	<div class="row">
		...
		<div class="col-sm-7 pl-5"><img src="{{ asset('img/acerca_de/acercade.png') }}" class="big_img disapear"></div>
	</div>

	<div class="row mt-0">
		<div class="col-sm-5 mt-0">
			<img class="img-fluid disapear" src="{{ asset('img/acerca_de/acercade2.png') }}">
		</div>
