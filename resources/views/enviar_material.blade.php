...
<div class="container text-center mt-3 disapear">
	<img src="{{ asset('img/enviar_material/quequiereshacer.png') }}" class="banner" style="opacity: 0.85;">
</div>
	...
	<div class="row justify content center p-3">
		<div class="col-7 bg-light">
			...
			<div class="row text-center mb-5">
				<div class="col-sm-3 m-3 bg-green p-3 text-white cut hover_animation" style="cursor: pointer;" onclick="location.href='{{ route('enviarProyecto')}}';">
