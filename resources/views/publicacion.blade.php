...
<link rel="stylesheet" type="text/css" href="{{ asset('css/publicacion.css') }}">
...
<div class="container">
	...
	<div class="row mt-5">
		<div class="col-sm-4">
			...
			<h1 class="mr-5"><b>Nombre del proyecto</b></h1>
		</div>

		<div class="col-sm-8">
			<img class="img-fluid" src="https://via.placeholder.com/1200x900">
		</div>
	...
	<div class="row mt-5">
		<div class="col-sm-4">
			...
			<h3 class="mr-5"><b>Lorem ipsum dolor sit amet, consectetur adipiscing elit</b></h3>
		</div>
	...
	<div class="row mt-5">
		...
		<div class="col-sm-4 cut">
			<div class="bg-blue p-5">
				<p class="text-center"><img class="img-fluid local_icon mt-5" src="{{ asset('img/icons/social.png') }}"></p>
		...
		<div class="col-sm-4 cut">
			<div class="bg-green p-5">
				<p class="text-center"><img class="img-fluid local_icon mt-5" src="{{ asset('img/icons/ambiental.png') }}"></p>
		...
		<div class="col-sm-4 cut">
			<div class="bg-orange p-5">
				<p class="text-center"><img class="img-fluid local_icon mt-5" src="{{ asset('img/icons/economico.png') }}"></p>
	...
	<h3 class="text-center"><b>Nombre Apellido</b></h3>
	<p class="text-center lead" style="letter-spacing: 3px;">PROYECTO</p>
